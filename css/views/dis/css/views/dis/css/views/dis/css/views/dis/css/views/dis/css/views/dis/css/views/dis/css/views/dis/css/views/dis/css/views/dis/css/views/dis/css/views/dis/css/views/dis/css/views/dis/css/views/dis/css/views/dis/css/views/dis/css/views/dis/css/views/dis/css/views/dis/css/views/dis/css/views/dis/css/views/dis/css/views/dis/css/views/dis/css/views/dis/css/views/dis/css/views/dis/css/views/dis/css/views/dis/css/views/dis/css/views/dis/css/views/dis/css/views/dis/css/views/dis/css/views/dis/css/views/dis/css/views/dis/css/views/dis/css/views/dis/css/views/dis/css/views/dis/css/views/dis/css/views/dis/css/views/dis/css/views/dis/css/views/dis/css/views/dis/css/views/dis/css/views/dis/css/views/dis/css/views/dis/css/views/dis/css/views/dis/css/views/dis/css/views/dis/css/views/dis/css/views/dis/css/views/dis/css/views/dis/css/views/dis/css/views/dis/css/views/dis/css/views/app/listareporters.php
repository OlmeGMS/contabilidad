    ...
    <div class="block full">
        ...
        <div class="block-title">
          <!--  <div class="block-options pull-right">
            ...
            <h2><strong>Todos</strong> Los Usuarios</h2> <a href="crearUsuarioReport"><i class="fa fa-plus"></i>Crear Nuevo Usuario reporter</a>
        </div>
        ...
        <table id="table-usuarios-app" class="table table-bordered table-striped table-vcenter">
            ...
            <tbody>
                ...
                <?php echo listUsariosReporters($idCompania, $idCentroCostos); ?>
...
<script type="text/javascript">
  ...
  $('tr #Eliminar_reporter').click(function(e){

    e.preventDefault();
    var opcion = confirm("¿Esta seguro en eliminar el reporter?");
    if (opcion) {
      var fila = $(this).parent().parent().parent();
      var reporter = fila.find('#idReporter').text();
      var data = {idreporter: reporter};
      $.post("../../controllers/app/vales/eliminarReporterController.php", data, function(res, est, jqXHR){
        alert('Eliminado');
        fila.remove();
      });
    }
