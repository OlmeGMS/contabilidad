...
$crearCiudad = '<a href="crearCiudad"><i class="fa fa-plus"></i>Agregar Nueva Ciudad</a>';
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-globe"></i>Ciudad<br><small>Aquí podras ver todos las ciudades donde funciona Taxisya!</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Tabla</li>
        <li><a href="">Consulta Ciudades</a></li>
    </ul>
    ...
    <div class="block full">
        ...
        <div class="block-title">
          <!--  <div class="block-options pull-right">
            ...
            <h2><strong>Todos</strong> Las ciudades</h2> <?php if($rol == 1 || $rol == 2){ echo $crearCiudad;} ?>&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="javascript:void(0)" onclick="$('#modal-search-user').modal('show');" id="btn-search-user"><i class="fa fa-search"></i>Busqueda personalizada</a>-->
        </div>
        <!-- END All Orders Title -->
<div class="table-responsive remove-margin-bottom">
        <!-- All Orders Content -->
        <?php echo tablaCiudadesFacade($rol); ?>
...
$('tr #Eliminar_ciudad').click(function(e){
  e.preventDefault();
  var opcion = confirm("¿Esta seguro que desea eliminar esta ciudad?");
  if (opcion) {
    var fila = $(this).parent().parent().parent();
    var ciudad = fila.find('#id_ciudad').text();
    var data = {idCiudad: ciudad};
    $.post("../../controllers/app/eliminarCiudadController.php", data, function(res, est, jqXHR){
