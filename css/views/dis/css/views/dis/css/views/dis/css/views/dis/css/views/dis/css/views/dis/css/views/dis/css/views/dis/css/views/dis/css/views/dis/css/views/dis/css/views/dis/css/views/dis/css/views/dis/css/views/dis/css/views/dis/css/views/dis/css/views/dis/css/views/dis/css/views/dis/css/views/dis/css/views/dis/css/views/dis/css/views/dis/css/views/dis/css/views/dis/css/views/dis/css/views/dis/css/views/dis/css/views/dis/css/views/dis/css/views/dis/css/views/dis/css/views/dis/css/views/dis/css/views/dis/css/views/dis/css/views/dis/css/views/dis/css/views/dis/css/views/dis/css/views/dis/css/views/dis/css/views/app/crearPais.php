  ...
  <div class="row">
    <div class="content-header">
      <div class="header-section">
        <h1>
          <i class="fa fa-globe"></i>Agregar País<br><small>Complete el siguiente formulario para agregar un nuevo país.</small>
        </h1>
      </div>
    </div>
    ...
    <div class="col-md-12">
      <div class="block">
        <div class="block-title">
          <h2><strong>Agregar Nuevo país</strong></h2>
        </div>
        <form id="form-empresa" action="../../controllers/app/agregarPaisController.php" method="post" class="form-horizontal form-bordered">
          <fieldset>
