  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="block">
        ...
        <form id="form-validation" action="../../controllers/app/agregarUsuarioAppFromController.php" method="post" class="form-horizontal form-bordered">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input type="hidden" id="rol" name="rol" class="form-control" value="5" >
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-4 control-label" for="apellido">Apellido<span class="text-danger">*</span></label>
              <div class="col-md-6">
                <input type="apellido" id="apellido" name="apellido" class="form-control" placeholder="Digite el email" >
              </div>
              <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input type="Documento" id="telefono" name="telefono" class="form-control" placeholder="Digite el Nº de documento" >
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-4 control-label" for="movil">Celular<span class="text-danger">*</span></label>
              <div class="col-md-6">
                <input type="Documento" id="movil" name="movil" class="form-control" placeholder="Digite el Nº de documento" >
              </div>
            </div>
            <div class="form-group">
