...
$crearMarca = '<a href="crearMarca"><i class="fa fa-plus"></i>Agregar Nueva Marca</a>';
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-cab"></i>E<br><small>Aquí podras ver todos las marcas de Taxisya!</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Tabla</li>
        <li><a href="">Consulta marcas</a></li>
    </ul>
    ...
    <div class="block full">
        ...
        <div class="block-title">
          <!--  <div class="block-options pull-right">
            ...
            <h2><strong>Todos</strong> Las marcas</h2> <?php if($rol == 1 || $rol == 2){ echo $crearMarca;} ?>&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="javascript:void(0)" onclick="$('#modal-search-user').modal('show');" id="btn-search-user"><i class="fa fa-search"></i>Busqueda personalizada</a>-->
        </div>
        <!-- END All Orders Title -->
<div class="table-responsive remove-margin-bottom">
        <!-- All Orders Content -->
        <?php echo tablaMarcas($rol); ?>
...
$('tr #Eliminar_marca').click(function(e){
  e.preventDefault();
  var opcion = confirm("¿Esta seguro que desea eliminar esta marca?");
  if (opcion) {
    var fila = $(this).parent().parent().parent();
    var marca = fila.find('#id_marca').text();
    var data = {idMarca: marca};
    $.post("../../controllers/app/EliminarMarcaController.php", data, function(res, est, jqXHR){
