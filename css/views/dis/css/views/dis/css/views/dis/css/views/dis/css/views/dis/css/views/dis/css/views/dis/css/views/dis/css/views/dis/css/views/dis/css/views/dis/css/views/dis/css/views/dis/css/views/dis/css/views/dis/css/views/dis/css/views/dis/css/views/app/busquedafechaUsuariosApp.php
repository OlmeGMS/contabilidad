...
$url = "../../controllers/app/reportes/reporteExcelUsurioAppFechaController.php?item=$item&&frase=$frase&&fecha1=$fecha1&&fecha2=$fecha2";
?>
<!-- Page content -->
<div id="page-content">
    ...
    <div class="block full">
        ...
        <table id="table-usuarios-app" class="table table-bordered table-striped table-vcenter">
            ...
            <tbody>
                ...
                <?php echo listaUsersBusquedaFacade($item, $frase, $fecha1, $fecha2); ?>
    <!-- END Responsive Full Block -->
          </tbody>
        </table>
            <a id="reporteExcel" href="<?php echo $url?>" data-toggle="tooltip" title="Excel" class="btn btn-default" ><i class="fa fa-file-excel-o"></i></a>
