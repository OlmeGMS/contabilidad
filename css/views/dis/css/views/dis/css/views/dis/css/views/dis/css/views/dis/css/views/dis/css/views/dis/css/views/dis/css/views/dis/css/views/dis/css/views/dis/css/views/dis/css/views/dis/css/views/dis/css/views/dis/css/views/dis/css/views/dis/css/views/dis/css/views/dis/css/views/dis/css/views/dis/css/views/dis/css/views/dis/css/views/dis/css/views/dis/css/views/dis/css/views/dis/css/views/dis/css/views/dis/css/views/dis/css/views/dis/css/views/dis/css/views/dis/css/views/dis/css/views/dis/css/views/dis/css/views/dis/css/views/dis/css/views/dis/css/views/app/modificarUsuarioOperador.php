  ...
  <div class="row">
    <div class="content-header">
      <div class="header-section">
        <h1>
          <i class="fa fa-edit"></i>Modificar Usuario<br><small>Complete el siguiente formulario para agregar un nuevo usuario</small>
        </h1>
      </div>
    </div>
      ...
      <div class="block">
        <div class="block-title">
          <h2><strong>Modificar Usuario</strong></h2>
            ...
            <?php echo modificarUsuarioCmsFacade($id); ?>
      </div>
    </div>
  </div>
  <!-- END Widgets Row -->
