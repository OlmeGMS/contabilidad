  ...
  <div class="row">
    <div class="content-header">
      <div class="header-section">
        <h1>
          <i class="fa fa-edit"></i>Buscar pagos por empresa<br><small>Complete el siguiente formulario para buscar los pagos por empresa</small>
        </h1>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="block">
        ...
        <form id="form-notificacion" action="../../controllers/app/vales/buscaPagosXEmpresaAdmController.php" method="post" class="form-horizontal form-bordered">
          <fieldset>
