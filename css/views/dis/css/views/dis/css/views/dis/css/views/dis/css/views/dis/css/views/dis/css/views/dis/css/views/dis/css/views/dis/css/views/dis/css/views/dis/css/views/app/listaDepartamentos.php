...
$crearPais = '<a href="crearDepartamento"><i class="fa fa-plus"></i>Agregar Nuevo Departamento</a>';
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-globe"></i>Departamento<br><small>Aquí podras ver todos los departamento donde funciona Taxisya!</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Tabla</li>
        <li><a href="">Consulta Departamento</a></li>
    </ul>
    ...
    <div class="block full">
        ...
        <div class="block-title">
          <!--  <div class="block-options pull-right">
            ...
            <h2><strong>Todos</strong> Los países</h2> <?php if($rol == 1 || $rol == 2){ echo $crearPais;} ?>&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="javascript:void(0)" onclick="$('#modal-search-user').modal('show');" id="btn-search-user"><i class="fa fa-search"></i>Busqueda personalizada</a>-->
        </div>
        <!-- END All Orders Title -->
<div class="table-responsive remove-margin-bottom">
        <!-- All Orders Content -->
        <?php echo tablaDepartamentosFacade($rol); ?>
...
$('tr #Eliminar_departamento').click(function(e){
  e.preventDefault();
  var opcion = confirm("¿Esta seguro que desea eliminar este departamento?");
  if (opcion) {
    var fila = $(this).parent().parent().parent();
    var departamento = fila.find('#id_departamento').text();
    var data = {idDepartamento: departamento};
    $.post("../../controllers/app/eliminarDepartamentoController.php", data, function(res, est, jqXHR){
