  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="block">
        ...
        <form id="form-validation" action="../../controllers/app/vales/agregarUsuarioReportController.php" method="post" class="form-horizontal form-bordered">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-4 control-label" for="telefono">Móvil<span class="text-danger">*</span></label>
              <div class="col-md-6">
