...
$crearPais = '<a href="crearPais"><i class="fa fa-plus"></i>Agregar Nuevo País</a>';
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-globe"></i>Países<br><small>Aquí podras ver todos los países donde funciona Taxisya!</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Tabla</li>
        <li><a href="">Consulta Países</a></li>
    </ul>
...
<div class="table-responsive remove-margin-bottom">
        <!-- All Orders Content -->
        <?php echo tablaPaisesFacade($rol); ?>
...
$('tr #Eliminar_pais').click(function(e){
  e.preventDefault();
  var opcion = confirm("¿Esta seguro que desea eliminar este país?");
  if (opcion) {
    var fila = $(this).parent().parent().parent();
    var pais = fila.find('#id_pais').text();
    var data = {idPais: pais};
    $.post("../../controllers/app/EliminarPaisController.php", data, function(res, est, jqXHR){
