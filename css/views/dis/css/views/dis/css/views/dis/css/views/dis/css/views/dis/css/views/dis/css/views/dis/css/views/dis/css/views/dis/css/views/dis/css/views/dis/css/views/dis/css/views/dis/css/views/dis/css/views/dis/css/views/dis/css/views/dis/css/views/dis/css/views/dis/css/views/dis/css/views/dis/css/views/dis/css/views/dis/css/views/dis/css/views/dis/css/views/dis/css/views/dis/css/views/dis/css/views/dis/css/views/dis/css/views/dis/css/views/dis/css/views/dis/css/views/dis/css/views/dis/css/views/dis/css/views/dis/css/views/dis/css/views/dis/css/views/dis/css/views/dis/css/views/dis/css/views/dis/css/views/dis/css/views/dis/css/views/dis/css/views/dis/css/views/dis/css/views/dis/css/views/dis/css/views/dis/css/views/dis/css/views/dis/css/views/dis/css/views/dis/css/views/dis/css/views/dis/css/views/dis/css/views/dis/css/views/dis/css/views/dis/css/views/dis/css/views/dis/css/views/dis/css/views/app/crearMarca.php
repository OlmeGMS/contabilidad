  ...
  <div class="row">
    <div class="content-header">
      <div class="header-section">
        <h1>
          <i class="fa fa-cab"></i>Agregar Marca<br><small>Complete el siguiente formulario para agregar una nueva marca.</small>
        </h1>
      </div>
    </div>
    ...
    <div class="col-md-12">
      <div class="block">
        <div class="block-title">
          <h2><strong>Agregar Nueva marca</strong></h2>
        </div>
        <form id="form-empresa" action="../../controllers/app/agregarMarcaController.php" method="post" class="form-horizontal form-bordered">
          <fieldset>
