  ...
  <div class="row">
    <div class="content-header">
      <div class="header-section">
        <h1>
          <i class="fa fa-globe"></i>Modificar País<br><small>Complete el siguiente formulario para modificar un país.</small>
        </h1>
      </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
      <li><a href="home.php">Incio</a></li>
      <li>Modificar País</li>
    </ul>
  </div>
    ...
    <div class="col-md-12">
      <div class="block">
        <div class="block-title">
          <h2><strong>Modificar país</strong></h2>
        </div>
          <?php echo modificarPaisFacade($idPais); ?>
      </div>
    </div>
  </div>
  <!-- END Widgets Row -->
