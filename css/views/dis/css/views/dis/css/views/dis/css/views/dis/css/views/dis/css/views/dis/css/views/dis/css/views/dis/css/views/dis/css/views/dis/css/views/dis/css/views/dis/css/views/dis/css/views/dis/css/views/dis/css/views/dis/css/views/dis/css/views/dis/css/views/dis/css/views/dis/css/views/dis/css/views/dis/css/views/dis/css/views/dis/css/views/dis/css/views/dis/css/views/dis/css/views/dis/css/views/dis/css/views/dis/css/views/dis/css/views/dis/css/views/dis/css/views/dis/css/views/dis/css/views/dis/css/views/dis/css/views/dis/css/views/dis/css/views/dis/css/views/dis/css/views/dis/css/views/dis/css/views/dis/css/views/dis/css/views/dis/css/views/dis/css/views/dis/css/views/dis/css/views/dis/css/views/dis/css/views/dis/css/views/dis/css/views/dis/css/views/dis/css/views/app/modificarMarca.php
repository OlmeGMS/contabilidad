  ...
  <div class="row">
    <div class="content-header">
      <div class="header-section">
        <h1>
          <i class="fa fa-cab"></i>Modificar Marca<br><small>Complete el siguiente formulario para modificar la marca.</small>
        </h1>
      </div>
    </div>
    ...
    <div class="col-md-12">
      <div class="block">
        <div class="block-title">
          <h2><strong>Modficiar marca</strong></h2>
        </div>
          <?php echo modificarMarcaFacade($idMarca); ?>
      </div>
    </div>
  </div>
  <!-- END Widgets Row -->
