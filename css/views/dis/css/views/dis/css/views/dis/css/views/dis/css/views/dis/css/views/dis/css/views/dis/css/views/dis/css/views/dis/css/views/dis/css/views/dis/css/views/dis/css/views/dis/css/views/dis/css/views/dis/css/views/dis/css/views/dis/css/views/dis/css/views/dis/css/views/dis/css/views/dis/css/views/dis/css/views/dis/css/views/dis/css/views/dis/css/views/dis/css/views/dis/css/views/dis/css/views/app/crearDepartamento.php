  ...
  <div class="row">
    <div class="content-header">
      <div class="header-section">
        <h1>
          <i class="fa fa-globe"></i>Agregar Departamento<br><small>Complete el siguiente formulario para agregar un nuevo departamento.</small>
        </h1>
      </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
      <li><a href="home.php">Incio</a></li>
      <li>Crear Departamento</li>
    </ul>
  </div>
    ...
    <div class="col-md-12">
      <div class="block">
        <div class="block-title">
          <h2><strong>Agregar Nuevo departamento</strong></h2>
        </div>
        <form id="form-empresa" action="../../controllers/app/agregarDepartamentoController.php" method="post" class="form-horizontal form-bordered">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Digite el nombre del departamento" >
              </div>
              <div class="col-md-6">
