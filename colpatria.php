...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Contabilidad - Archivo plano</title>

        <meta name="description" content="Generador de archivos planos">
        <meta name="author" content="taxisya">
    ...
    <body>
        ...
        <div id="page-wrapper">
            ...
            <div class="preloader themed-background">
                <h1 class="push-top-bottom text-light text-center"><strong>Real</strong>Trasportadora</h1>
                <div class="inner">
                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <a href="index.html" class="sidebar-brand">
                                <i class="fa fa-bus"></i><span class="sidebar-nav-mini-hide"><strong>Celuvans</strong></span>
                            </a>
                            <!-- END Brand -->
                            ...
                            <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                                ...
                                <div class="sidebar-user-name">Contabilidad</div>
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="colpatria.php"><i class="fa fa-bank sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Colpatria</span></a>
                                </li>
                ...
                <div id="main-container">
                        ...
                        <ul class="nav navbar-nav-custom">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-custom dropdown-options">
                                    ...
                                    <li class="dropdown-header text-center">Estilo página</li>
                                    <li>
                                        <div class="btn-group btn-group-justified btn-group-sm">
                    ...
                    <footer class="clearfix">
                        <div class="pull-right">
                            Creado por <a href="http://taxisya.co" target="_blank">Taxisya</a>
                        </div>
                        <div class="pull-left">
