    ...
    <div class="col-md-12">
      ...
      <div class="block">
        ...
        <div class="tab-content">
            ...
            <form id="formulario-efectivo" action="../../controllers/app/agregarAgendamientoNuevoController.php" method="post" class="form-horizontal form-bordered" name="form-efectivo">
              <fieldset>
