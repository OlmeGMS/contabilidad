...
require_once('../../models/scheduleTypes.php');
require_once('../../facades/servicesFacade.php');
require_once('../../facades/barrioFacade.php');
require_once('../../facades/schedulesTypesFacade.php');
  ...
  <div class="row">
    <div class="content-header">
      <div class="header-section">
        <h1>
          <i class="fa fa-edit"></i>Solicitar Agendamiento<br><small>Complete el siguiente formulario para solicitar un agendamiento</small>
        </h1>
      </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
      <li><a href="home.php">Incio</a></li>
      <li>Solicitar agendamiento</li>
    </ul>
  </div>
    ...
    <div class="col-md-12">
      <div class="block">
        <div class="block-title">
          <h2><strong>Teléfono del agendamiento</strong></h2>
        </div>
        <form id="form-validation" action="../../controllers/app/buscarTelefonoServicioController.php" method="post" class="form-horizontal form-bordered">
          <fieldset>
            <legend><i class="fa fa-angle-right"></i> Datos del agendamiento</legend>
      ...
      <div class="block">
        ...
        <div class="block-title">
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active"><a id="sel-efectivo" href="#efectivo">Información</a></li>
            </ul>
        </div>
        <div class="tab-content">
            <div class="tab-pane active" id="efectivo">
            <form id="formulario-efectivo" action="../../controllers/app/agregarAgendamientoController.php" method="post" class="form-horizontal form-bordered" name="form-efectivo">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label" for="tipoAgendamiento">Tipo servicio<span class="text-danger">*</span></label>
                  <div class="col-md-6">
                    <select id="tipoAgendamiento" name="tipoAgendamiento" class="select-chosen" data-placeholder="Seleccione el barrio" style="width: 250px;">
                      <option selected disabled>Seleccione el tipo de servicio</option>
                      <?php echo todosSchedulesTypeFacade(); ?>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label" for="fechaFin">Fecha del Servicio</label>
                  <div class="col-md-6">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="example-timepicker24">Hora del servicio (24h)</label>
                    <div class="col-md-6">
