...
$nconductores = $consultaConductores->obtenerConteoCondutoresAceptados();

$habilitados = $consultaConductores->obtenerConteoConductoresHabilitados();
    ...
    <div class="block full">
        ...
        <div class="block-title">
          <!--  <div class="block-options pull-right">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<span>Nº Conductores Aceptados: <i><?php echo $nconductores; ?></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span>Nº Conductores habilitados: <i class="label label-info"><?php echo $habilitados; ?></i></span>
        </div>
        <!-- END All Orders Title -->
<div class="table-responsive remove-margin-bottom">
        <!-- All Orders Content -->
        <?php echo listaConductoresFacade($rol); ?>
