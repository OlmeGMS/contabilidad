...
$crearEmpresa = '<a href="crearEmpresaTaxi"><i class="fa fa-plus"></i>Agregar Nueva Empresa</a>';
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-cab"></i>Empresas de taxis Registradas<br><small>Aquí podras ver todas las empresas de taxis registradas en el sistema!</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Tabla</li>
        <li><a href="">Consulta de las Empresas</a></li>
    </ul>
    ...
    <div class="block full">
        ...
        <div class="block-title">
          <!--  <div class="block-options pull-right">
            ...
            <h2><strong>Todos</strong> Las empresas</h2> <?php if($rol == 1 || $rol == 2){ echo $crearEmpresa;} ?>&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="javascript:void(0)" onclick="$('#modal-search-user').modal('show');" id="btn-search-user"><i class="fa fa-search"></i>Busqueda personalizada</a>-->
        </div>
        <!-- END All Orders Title -->
<div class="table-responsive remove-margin-bottom">
        <!-- All Orders Content -->
        <?php echo tablaEmpresasFacade($rol); ?>
...
$('tr #Eliminar_empresa').click(function(e){
  e.preventDefault();
  var opcion = confirm("¿Esta seguro en eliminar esta empresa?");
  if (opcion) {
    var fila = $(this).parent().parent().parent();
    var empresa = fila.find('#empresa_id').text();
    var data = {idEmpresa: empresa};
    $.post("../../controllers/app/EliminarEmpresaController.php", data, function(res, est, jqXHR){
